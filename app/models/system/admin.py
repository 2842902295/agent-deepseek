...
class User(BaseModel, TimestampMixin):
    ...
    skill_code = fields.CharField(
        ...
        unique=True,
        null=True,
        description="技能专属code：系统自动生成的随机短码，仅用于拼接技能 skill_key（专属code_技能名），与登录名/手机号解耦防泄露",
    )
    ...
    profession_id = fields.IntField(null=True, description="所选职业ID（agent_profession.id），null=未引导")
