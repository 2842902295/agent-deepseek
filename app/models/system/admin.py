...
class User(BaseModel, TimestampMixin):
    ...
    skill_code = fields.CharField(
        max_length=16,
        unique=True,
        null=True,
        description="技能专属code：系统自动生成的随机短码，仅用于拼接技能 skill_key（技能名_专属code），与登录名/手机号解耦防泄露",
    )
    ...
    onboarded_at = fields.DatetimeField(null=True, description="完成新手引导时间，null=需弹引导")
...
class Log(BaseModel):
    ...
    by_user: fields.ForeignKeyRelation['User'] = fields.ForeignKeyField("app_system.User", null=True, related_name=None, on_delete=fields.NO_ACTION, description="关联专员")
