const local: App.I18n.Schema = {
  ...
  route: {
    ...
    ai: 'AI 工具',
    'ai_all-ind': '全量指标',
    'ai_batch-deduplication': '批量去重',
    'ai_batch-detail': '去重详情',
    ai_nian: '知识库',
    'ai_obj-rel': '对象关系',
    ai_qa: '全能助理',
    'ai_standard-base-info': '标准基础信息',
    'ai_standard-ind': '标准指标',
    'ai_standard-obj': '标准对象',
    ai_workbench: 'AI 助理中心',
    manage: '系统管理',
    manage_log: '日志管理',
    manage_api: 'API管理',
    manage_user: '用户管理',
  ...
  form: {
    ...
    pwd: {
      required: '请输入密码',
      invalid: '密码格式不正确，6-18位，需同时包含字母、数字和特殊字符'
    },
    confirmPwd: {
      required: '请输入确认密码',
      invalid: '两次输入密码不一致'
