...
export const generatedRoutes: GeneratedRoute[] = [
    ...
    children: [
      {
        name: 'ai_all-ind',
        path: '/ai/all-ind',
        component: 'view.ai_all-ind',
        meta: {
          title: 'ai_all-ind',
          i18nKey: 'route.ai_all-ind'
        }
      },
      {
        name: 'ai_batch-deduplication',
        path: '/ai/batch-deduplication',
        component: 'view.ai_batch-deduplication',
        meta: {
          title: 'ai_batch-deduplication',
          i18nKey: 'route.ai_batch-deduplication'
        }
      },
      {
        name: 'ai_batch-detail',
        path: '/ai/batch-detail',
        component: 'view.ai_batch-detail',
        meta: {
          title: 'ai_batch-detail',
          i18nKey: 'route.ai_batch-detail'
        }
      },
      {
        name: 'ai_dashboard',
        path: '/ai/dashboard',
        component: 'view.ai_dashboard',
        meta: {
          title: 'ai_dashboard',
          i18nKey: 'route.ai_dashboard'
        }
      },
      {
        name: 'ai_home',
        path: '/ai/home',
        component: 'view.ai_home',
        meta: {
          title: 'ai_home',
          i18nKey: 'route.ai_home'
        }
      },
      {
        name: 'ai_nian',
        path: '/ai/nian',
        component: 'view.ai_nian',
        meta: {
          title: 'ai_nian',
          i18nKey: 'route.ai_nian'
        }
      },
      {
        name: 'ai_obj-rel',
        path: '/ai/obj-rel',
        component: 'view.ai_obj-rel',
        meta: {
          title: 'ai_obj-rel',
          i18nKey: 'route.ai_obj-rel'
        }
      },
      {
        name: 'ai_qa-glass',
        path: '/ai/qa-glass',
        component: 'view.ai_qa-glass',
        meta: {
          title: 'ai_qa-glass',
          i18nKey: 'route.ai_qa-glass'
        }
      },
      {
        name: 'ai_quick-action-manage',
        path: '/ai/quick-action-manage',
        component: 'view.ai_quick-action-manage',
        meta: {
          title: 'ai_quick-action-manage',
          i18nKey: 'route.ai_quick-action-manage'
        }
      },
      {
        name: 'ai_standard-base-info',
        path: '/ai/standard-base-info',
        component: 'view.ai_standard-base-info',
        meta: {
          title: 'ai_standard-base-info',
          i18nKey: 'route.ai_standard-base-info'
        }
      },
      {
        name: 'ai_standard-ind',
        path: '/ai/standard-ind',
        component: 'view.ai_standard-ind',
        meta: {
          title: 'ai_standard-ind',
          i18nKey: 'route.ai_standard-ind'
        }
      },
      {
        name: 'ai_standard-obj',
        path: '/ai/standard-obj',
        component: 'view.ai_standard-obj',
        meta: {
          title: 'ai_standard-obj',
          i18nKey: 'route.ai_standard-obj'
        }
      },
      {
        name: 'ai_workbench',
        path: '/ai/workbench',
        component: 'view.ai_workbench',
        meta: {
          title: 'ai_workbench',
          i18nKey: 'route.ai_workbench'
        }
      },
      {
        name: 'ai_workflow',
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'manage_standard-plagiarism-name',
        path: '/manage/standard-plagiarism-name',
        component: 'view.manage_standard-plagiarism-name',
        meta: {
          title: 'manage_standard-plagiarism-name',
          i18nKey: 'route.manage_standard-plagiarism-name'
        }
      },
      {
        name: 'manage_user',
