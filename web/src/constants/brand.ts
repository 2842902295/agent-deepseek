interface BrandText {
  ...
  /** 「专家」体系的用户可见称谓：standard 版称「助理」，generic 版称「专家」 */
  expertLabel: string;
  ...
  /** 桌面版 loading 页标语（pack_desktop.py 打包期解析，替换 __APP_TAGLINE__） */
...
const BRAND_STANDARD: BrandText = {
  ...
  qaSidebarTitle: "同道·标准工作台",
  desktopTagline: "智能标准化管理平台，为专业工作者而生",
...
const BRAND_GENERIC: BrandText = {
  ...
  emptyCapability: "还没有 AI 助理，先在全能助理这跑一段对话再凝练出一位吧",
  emptyPkg: '还没有技能包，点右上角"发现技能"让 AI 助理帮你找一些',
  qaSidebarTitle: "agent-deepseek",
  desktopTagline: "对话即工作 · 所问皆所学 · 所做皆所能",
  qaWelcomeLine1: "对话即工作",
  qaWelcomeLine2: "所问皆所学",
  qaWelcomeLine3: "所做皆所能",
