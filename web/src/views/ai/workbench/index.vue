...
type SourceFilter = 'all' | 'builtin' | 'derived' | 'curated';
      ...
      <div class="wb-drawer">
        ...
        <div class="wb-drawer-body">
          <div class="wb-drawer-keyrow">
            ...
            <span v-if="!viewing.isEnabled" :class="`wb-badge-${viewing.source}`" class="wb-badge">{{ sourceLabel[viewing.source] }}</span><!-- 来源徽章仅在未上架技能展示 -->
