...
// 起草单位（源表已将主要起草单位并入 draft_unit 单字段，直接展示）
const draftUnitText = computed(() => data.value.draft_unit || '')
