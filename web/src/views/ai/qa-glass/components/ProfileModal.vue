...
:root[data-qa-theme='ink'] .pfm-card {
  --paper: #fbfbfc;
  --surface: #ffffff;
...
:root[data-qa-theme='ink'] .pfm-glow {
  display: none;
}

:root[data-qa-theme='ink'] .pfm-head {
  border-bottom-color: rgba(31, 32, 36, 0.07);
}

:root[data-qa-theme='ink'] .pfm-input,
:root[data-qa-theme='ink'] .pfm-seg-item {
  border-color: rgba(31, 32, 36, 0.1);
}

:root[data-qa-theme='ink'] .pfm-input:focus {
  border-color: rgba(31, 32, 36, 0.3);
  box-shadow: 0 0 0 3px rgba(23, 24, 26, 0.06);
}

:root[data-qa-theme='ink'] .pfm-btn--primary {
  box-shadow: none;
}
</style>
