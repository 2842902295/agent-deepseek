...
import { getDevQuickLoginPassword } from '@/utils/dev-login';
...
// 口令来自 env（VITE_DEV_QUICK_LOGIN_PWD），不硬编码进仓库
const devPassword = getDevQuickLoginPassword();

const accounts: Account[] = [
  { key: 'super', label: '超级管理员', userName: 'Super', password: devPassword },
  { key: 'admin', label: '管理员', userName: 'Admin', password: devPassword },
  { key: 'user', label: '普通用户', userName: 'User', password: devPassword }
];
