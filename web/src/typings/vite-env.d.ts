...
declare namespace Env {
  ...
  interface ImportMeta extends ImportMetaEnv {
    ...
    /** Brand variant for text/copy switching */
    readonly VITE_BRAND?: 'standard' | 'generic';
    /** 自动登录（开发便捷）：取值 Super / Admin / User，留空关闭 */
    readonly VITE_AUTO_LOGIN?: string;
    /**
     * 开发者面板 / 快捷切换账号使用的口令
     *
     * 真实值只写在 web/.env（不进公开仓库）；留空时回落到后端播种账号的默认口令
     */
    readonly VITE_DEV_QUICK_LOGIN_PWD?: string;
  }
}
